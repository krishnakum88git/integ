...
export default () => (
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="-123 0 300 21.875" enable-background="new -123 0 300 21.875" style={{display: 'block'}}>
